...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ModelAndView handleInvalidItemException(InvalidItemException ex, Principal principal) {
    ...
    public ModelAndView handleNotEnoughMoneyException(NotEnoughMoneyException ex, Principal principal) {
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("lotsError");
        modelAndView.addObject("message", ex.getMessage());
        return modelAndView;
